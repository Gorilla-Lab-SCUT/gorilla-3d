...
def visualize_pts_rgb(pts, rgb, room_name):
    mesh_file = osp.join("..", "dataset", "scannetv2", "test", room_name + "_vh_clean_2.ply")
    ...
    mesh += pred_mesh
    o3d.io.write_triangle_mesh(osp.join(".", "vis_trainval", room_name+".ply"), mesh)
...
if __name__ == "__main__":
    ...
    visualize_pts_rgb(xyz, rgb, opt.room_name)
